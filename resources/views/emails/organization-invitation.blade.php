...
<table style="max-width: 640px; margin: 0 auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.08);">
    <tr>
        <td style="padding: 40px; text-align: center; background: white;">
    ...
    <tr>
        <td style="padding: 40px; text-align: center; color: #374151;">
            <p style="font-size: 16px; margin-bottom: 24px;">
                {{ __('organization.email_invited_to', ['organization' => $organizationName]) }}
            </p>

            <a href="{{ $url }}"
               style="background-color: #38a169; color: #ffffff; padding: 14px 32px; border-radius: 9999px; font-weight: 600; text-decoration: none; display: inline-block; box-shadow: 0 2px 6px rgba(0,0,0,0.15); margin-bottom: 24px;">
                {{ __('organization.email_join_button') }}
            </a>

            <p style="font-size: 14px; color: #6b7280; margin-top: 24px;">
                {{ __('organization.email_invitation_note') }}
            </p>

            <p style="font-size: 14px; color: #6b7280; margin-top: 24px;">
                {{ __('organization.email_signature') }},<br>
